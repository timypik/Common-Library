...
#if defined (CRC8_FAST_CALCULATION)
/**
 * @note
 * This table need for fast compute Dallas Semiconductor 8 bit CRC
 */
...
# pragma message("CRC8 fast calculation")
#elif defined (CRC8_SLOW_CALCULATION)
# pragma message("CRC8 slow calculation")
#else
# error "Set CRC8 calculation speed!"
#endif
